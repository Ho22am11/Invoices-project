				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						...
						<div>
						  ...
						  <p class="mg-b-0">الصفحه الرئيسية</p>
						</div>
					</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">{{ 'عدد الفواتير المدفوعه'.' '.count(\App\Models\invoices::where('Value_Status','=', 2)->get())}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7"> {{ 'عدد الفواتير المدفوعه'.' '.count(\App\Models\invoices::where('Value_Status','=', 1)->get())}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ '$'.number_format(\App\Models\invoices::where('Value_Status','=', 3)->sum('Total',3))}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ 'عدد الفواتير المدفوعه جزئيا'.' '.count(\App\Models\invoices::where('Value_Status','=', 3)->get())}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
