...
Route::get('View_file/{invoice_number}/{file_name}', [InvolcesAttachmentController::class, 'ope']);
Route::get('View_tile/{invoice_number}/{file_name}', [InvolcesAttachmentController::class, 'down']);
Route::post('View_tile/{invoice_number}/{file_name}', [InvolcesAttachmentController::class, 'del']);
...
Route::get('/dashboard', [HomeController::class, 'index'])->name('index')->middleware(['auth', 'verified']);
